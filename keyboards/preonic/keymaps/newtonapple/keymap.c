...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_preonic_grid(
    ...
    CRTL_SLBRC, KC_LCTL, ALT_T_LBRC, GUI_T_EQL, SYM_SMINS, MACVIM_SPC, MACVIM_SQUOT, SFT_T_QUOT, NUM_MINS, GUI_T_RBRC, ADJ_BSLS, CRTL_SRBRC
  ),
  ...
  [_MOUSE] = LAYOUT_preonic_grid(
    ...
    DEFAULT, SEL_ALL, KC_ACL0, KC_ACL1, KC_ACL2, KC_PGDN, KC_MS_L, KC_MS_D, KC_MS_U,  KC_MS_R,  COPY,    PASTE,
    _______, _______, _______, _______, KC_LSFT, _______, KC_WH_L, KC_WH_D, KC_WH_U,  KC_WH_R,  KC_UP,   KC_UP,
    _______, _______, _______, _______, KC_LSFT, KC_ACL1, KC_ACL0, KC_BTN1, KC_BTN2,  KC_LEFT,  KC_DOWN, KC_RGHT
  ),
