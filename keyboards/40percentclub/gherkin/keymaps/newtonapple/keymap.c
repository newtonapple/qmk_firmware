...
[_QWERTY] = LAYOUT_ortho_3x10(
    ...
    MT(MOD_LCTL, KC_Z), MT(MOD_LALT, KC_X), MT(MOD_LGUI, KC_C), LT(_SYM, KC_V), MT(MOD_LSFT, KC_SPC), MT(MOD_LSFT, KC_BSPC), LT(_NUM,KC_B), MT(MOD_RGUI, KC_N), LT(_ADJUST, KC_M), LT(_NUM, KC_COMM)
),

[_MACVIM] = LAYOUT_ortho_3x10(
    ...
    UNDO,    VIM_X, VIM_C,  VIM_V,    LT(_VIMNUM, KC_ENTER), LT(_VIMNUM, KC_BSPC), VIM_B,    UNINDENT, INDENT,  KC_BSPC
 ),

[_VIMNUM] = LAYOUT_ortho_3x10(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
 ),

[_MOUSE] = LAYOUT_ortho_3x10(
    KC_TAB,  KC_MS_U, KC_ACL0, KC_ACL1, KC_PGUP, COPY,    UNDO,    PREV_TAB, NEXT_TAB, PASTE,
    LT(_MACVIM,KC_ESC),  KC_MS_D, KC_MS_L, KC_MS_R, KC_PGDN, KC_MS_L, KC_MS_D, KC_MS_U,  KC_MS_R,  KC_ENT,
    UNDO,    CUT,  KC_BTN1, KC_BTN2, MT(MOD_LSFT, KC_ENT), MT(MOD_LSFT, KC_ENT), MT(MOD_RSFT, KC_COMM), KC_DOT, KC_SLSH, MT(MOD_RSFT, KC_QUOT)
 ),

[_NUM] = LAYOUT_ortho_3x10(
    KC_GRV,   S(KC_GRV), KC_EQL, KC_MINS, S(KC_EQL), KC_LBRC,   KC_RBRC, S(KC_BSLS), KC_BSLS, KC_SCLN,
    KC_1,     KC_2,      KC_3,   KC_4,    KC_5,       KC_6,     KC_7,    KC_8,       KC_9,    KC_0,
    MT(MOD_LSFT, KC_BSPC),  KC_DEL, MT(MOD_RGUI, KC_COMM),  SYM_SMINS, MT(MOD_LSFT, KC_SPC), MT(MOD_LSFT, KC_ENT), KC_COMM, KC_DOT, KC_SLSH, MT(MOD_RSFT, KC_BSPC)
),
...
[_SYM] = LAYOUT_ortho_3x10(
    ...
    MT(MOD_LSFT, KC_BSPC),  KC_DEL, MT(MOD_RGUI, KC_COMM),  SYM_SMINS, MT(MOD_LSFT, KC_SPC), MT(MOD_LSFT, KC_ENT), S(KC_COMM), S(KC_DOT), S(KC_SLSH), MT(MOD_RSFT, KC_BSPC)
),
...
[_ADJUST] = LAYOUT_ortho_3x10(
    ...
    RESET,         BL_BRTG,   RGB_TOG,     VLK_TOG,   MO(_FN), RGB_HUI,  RGB_HUD, BL_INC, _______, BL_DEC
),
