 ...
 */
 ...
 [_MACVIM] = LAYOUT_ortho_5x15(
	...
	QWERTY,    SEL_ALL, SAVE,    VIM_D,    CMD_LEFT, CMD_RGHT, _______,   SNAP_CENTER, _______,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT, COPY,    PASTE,
	TG_VIMNUM, UNDO,    VIM_X,   VIM_C,    VIM_V,    VIM_B,    _______,   SNAP_UP,     _______,   PREV_TAB, NEXT_TAB, UNINDENT, INDENT,  _______, MO_VIMNUM,
	_______,   _______, _______, _______,  KC_LSFT,  KC_LCTL,  SNAP_LEFT, SNAP_DOWN,   SNAP_RGHT, _______,  KC_LSFT, MO_VIMNUM, _______, _______, _______
 ),
