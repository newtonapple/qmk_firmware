...
[_QWERTY] = LAYOUT_split_space_bs_blocker_wrapper(
    ADJ_GRV,    ________________NUMBER_LEFT________________, ________________NUMBER_RIGHT_______________, KC_MINS,     KC_EQL,  KC_BSLASH, KC_DEL,  CMD_UP,
    MOUSE_TAB,  _________________QWERTY_L1_________________, _________________QWERTY_R1_________________, MACVIM_LBRC, KC_RBRC, KC_BSPC,            KC_PGUP,
