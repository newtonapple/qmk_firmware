...
[_QWERTY] = LAYOUT_split_bs_blocker_wrapper(
    ...
    KC_LSPO,    _________________QWERTY_L3_________________, _________________QWERTY_R3_________________,          KC_RSPC,                   KC_UP,   CMD_DOWN,
                         ___________________ANSI_QWERTY_L4_, NUM_MINS, ADJ_SRBRC,                                                    KC_LEFT, KC_DOWN, KC_RGHT
),

[_CAP] = LAYOUT_split_bs_blocker_wrapper(
...
[_MACVIM] = LAYOUT_split_bs_blocker_wrapper(
    ...
    ________________ORTHO_GRID_MACVIM_L3________________, ________________ORTHO_GRID_MACVIM_R3________________,                   _______, SNAP_CENTER,
                               KC_LSFT, _______, _______, KC_BSPC,                          KC_LSFT, MO_VIMNUM,          _________BLANK_3_________
),

[_VIMNUM] = LAYOUT_split_bs_blocker_wrapper(
    ...
    ________________ORTHO_GRID_VIMNUM_L3________________, ________________ORTHO_GRID_VIMNUM_R3________________,                   _______, _______,
                               _________BLANK_3_________, KC_BSPC,                            _______, _______,          _________BLANK_3_________
),

[_MOUSE] = LAYOUT_split_bs_blocker_wrapper(
    ...
    ________________ORTHO_GRID_MOUSE_L3_________________, ________________ORTHO_GRID_MOUSE_R3_________________,                   _______, SNAP_CENTER,
                               KC_LSFT, _______, _______, KC_BTN1,                            KC_BTN2, KC_BTN2,          _________BLANK_3_________
),

[_NUM] = LAYOUT_split_bs_blocker_wrapper(
...
[_SYM] = LAYOUT_split_bs_blocker_wrapper(
...
[_ADJUST] = LAYOUT_split_bs_blocker_wrapper(
